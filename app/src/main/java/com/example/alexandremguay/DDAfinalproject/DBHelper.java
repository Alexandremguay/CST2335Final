...
public class DBHelper extends SQLiteOpenHelper {
        ...
        public com.example.alexandremguay.DDAfinalproject.RecordingMemo getItemAt(int position) {
        ...
        public void renameItem(com.example.alexandremguay.DDAfinalproject.RecordingMemo item, String recordingName, String filePath) {
            SQLiteDatabase database = getWritableDatabase();
            ContentValues values = new ContentValues();
            values.put(DBHelperItem.COLUMN_NAME_RECORDING_NAME, recordingName);
            values.put(DBHelperItem.COLUMN_NAME_RECORDING_FILE_PATH, filePath);
