package com.example.alexandremguay.DDAfinalproject.fragements;
...
import com.example.alexandremguay.DDAfinalproject.RecordingService;
...
public class RecordFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        chronometerObject = recordView.findViewById(R.id.chronometer);
        //update recording prompt text
        memoRecordingPrompt = recordView.findViewById(R.id.recording_status_text);
        memoRecordButton = recordView.findViewById(R.id.btnRecord);
